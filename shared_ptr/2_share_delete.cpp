/**
 * @file 2_share_delete.cpp
 * @brief shared_ptr 的自定义删除器用例，监控 delete 的调用; shared_ptr 的大小: 控制块内存和原始对象内存
 * @author Albert
 * @version 1.0.0
 * @date 2024-12-01
 */
...
int main()
{
    ...
    {
        shared_ptr<Widget> w4(new Widget(1000, 2000, 3000), deleteFunction);
        w4->print();
        cout << sizeof(w4) << endl;
    }
}
