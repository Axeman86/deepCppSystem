/**
 * @file 4_unique_api.cpp
 * @brief unique_ptr的使用方法，以及make_unique的使用方法 and API use
 * @author Albert
 * @version 1.0.0
 * @date 2024-11-25
 */
...
unique_ptr<Widget> getWidgetPtr()
{
    ...
    // return unique_ptr<Widget> {new Widget(100,200,300)};
}
...
int main()
{
...

    {
        ...
        w3.reset(nullptr); // 等价 w3=nullptr;
