...
{
    // MyClass mc;  // 如果使用了组合模式，在 swap 时 MyClass 会有 1 move ctor and 2 move assignment
    Point * data;
    int value;

public:
    Widget(int x = 0, int y = 0) : data(new Point(x, y)) { cout << "ctor data pointer:" << hex << data << endl; }
